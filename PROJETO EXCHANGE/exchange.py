                        ...
                        if resultado == 1:
                            ...
                            try:
                                ...
                                if valortaxado <= saldousuario: #verifica se o valor COM TAXA está no saldo do usuario para realizar a operação.
                                    ...
                                    extrato = (str(data_hora_formatada) + ' - ' + valorfinal_str + " BRL" + " CT: " + str(btc_price) + "     TX: 0.02 SALDO: R$ " + "{:.2f}".format(saldousuario) + " BTC: " + str(bitcoinusuario))
                            ...
                            try:
                                ...
                                if valortaxado <= saldousuario:
                                    ...
                                    valorfinal_str = "{:.2f}".format(valortaxado)
                                    extrato = (str(data_hora_formatada) + ' - ' + valorfinal_str + " BRL" + " CT: " + str(eth_price) + "     TX: 0.02 SALDO: R$ " + "{:.2f}".format(saldousuario) + " ETH: " + str(etherumusuario))
                                    cadastros[userlogin][3].append(extrato)
                                    cadastros[userlogin] = (cadastros[userlogin][0], cadastros[userlogin][1], saldousuario, cadastros[userlogin][3], bitcoinusuario, etherumusuario, rippleusuario)
                                    print("\nSucesso!")
                                    break
                            ...
                            try:
                                ...
                                if valortaxado <= saldousuario:
                                    ...
                                    valorfinal_str = "{:.2f}".format(valortaxado)
                                    extrato = (str(data_hora_formatada) + ' - ' + valorfinal_str + " BRL" + " CT: " + str(xrp_price) + "     TX: 0.02 SALDO: R$ " + "{:.2f}".format(saldousuario) + " XRP: " + str(rippleusuario))
                                    cadastros[userlogin][3].append(extrato)
                                    cadastros[userlogin] = (cadastros[userlogin][0], cadastros[userlogin][1], saldousuario, cadastros[userlogin][3], bitcoinusuario, etherumusuario, rippleusuario)
                                    print("\nSucesso!")
                                    break
                    ...
                    if resultado == 1:
                        ...
                        try:
                            ...
                            if valor <= bitcoinusuario: #verifica se o usuário possui o valor em cripto para realizar a operação.
                                ...
                                extrato = (str(data_hora_formatada) + ' + ' + valorfinal_str + " BRL" + " CT: " + str(btc_price) + "     TX: 0.03 SALDO: R$ " + "{:.2f}".format(saldousuario) + " BTC: " + str(bitcoinusuario))
                                cadastros[userlogin][3].append(extrato)
                                cadastros[userlogin] = (cadastros[userlogin][0], cadastros[userlogin][1], saldousuario, cadastros[userlogin][3], bitcoinusuario, etherumusuario, rippleusuario)
                                print("\nSucesso!")
                                break
                        ...
                        try:
                            ...
                            if valor <= rippleusuario:
                                ...
                                saldousuario = saldousuario + valorfinal
                                valorfinal_str = "{:.2f}".format(valorfinal)
                                extrato = (str(data_hora_formatada) + ' + ' + valorfinal_str + " BRL" + " CT: " + str(xrp_price) + "    TX: 0.01 SALDO: R$ " + "{:.2f}".format(saldousuario) + " XRP: " + str(rippleusuario))
                                cadastros[userlogin][3].append(extrato)
                                cadastros[userlogin] = (cadastros[userlogin][0], cadastros[userlogin][1], saldousuario, cadastros[userlogin][3], bitcoinusuario, etherumusuario, rippleusuario)
                                print("\nSucesso!")
                                break
...
cadastros = {
    '53406698824':('kaique','123456',200,[],1,1,1) #Deixei aqui um usuário já cadastrado para facilitar os testes.
    }                                              
extrato = []
